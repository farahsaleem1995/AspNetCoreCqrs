    ...
    public static class SignInResultExtensions
    {
        public static Result ToApplicationResult(this SignInResult signInResult)
        {
            return signInResult.Succeeded
                ? Result.Success()
                : Result.BadRequest(new List<string>{ "User name and password does not match"});
        }
        ...
        public static Result<TData> ToApplicationResult<TData>(this SignInResult signInResult)
        {
            return signInResult.Succeeded
                ...
                : Result.Unauthorized<TData>(new List<string>{ "User name and password does not match"});
        }
